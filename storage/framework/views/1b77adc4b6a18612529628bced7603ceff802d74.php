<?php $__env->startSection('page_title', 'BuyPowerNow - User Dashboard'); ?>
...
<div class="card-deck">
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
        ...
        <div class="card-body position-relative">
            <h6>Transactions</h6>
            <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif text-info" data-countupp='{"count":23434,"format":"alphanumeric"}'>NGN 0.00</div><a class="font-weight-semi-bold fs--1 text-nowrap" href="/dashboard/transactions">all transactions<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
        </div>
    </div>
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
        ...
        <div class="card-body position-relative">
            <h6>Wallet</h6>
            <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif" data-countup='{"count":43594,"format":"comma","prefix":"NGN"}'>
                NGN<?php use Illuminate\Support\Facades\DB;$balance = DB::table('deposits')->where('email', '=', auth()->user()->email)->sum('amount');?><?php echo $balance ?>
            </div><a class="font-weight-semi-bold fs--1 text-nowrap" href="/dashboard/fund-account">deposit cash<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\buypowernow\resources\views//dashboard/admin/index.blade.php ENDPATH**/ ?>