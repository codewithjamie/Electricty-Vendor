    ...
    <div class="container" data-layout="container">
      <nav class="navbar navbar-vertical navbar-expand-xl navbar-light">
        ...
        <div class="collapse navbar-collapse navbar-glass perfect-scrollbar scrollbar" id="navbarVerticalCollapse">
          ...
          <ul class="navbar-nav flex-column">
            <li class="nav-item"><a class="nav-link " href="/user/purchase" >
            ...
            <li class="nav-item"><a class="nav-link " href="/user/commissions">
            ...
            <li class="nav-item"><a class="nav-link " href="/user/buy-power">
          ...
          <div class="settings px-3 px-xl-0">
            ...
            </div><a class="btn btn-falcon-primary btn-sm btn-block btn-lg my-3" href="/user/kyc"> KYC </a>
          </div>
          <div class="settings px-3 px-xl-0">
            <div class="navbar-vertical-divider">
              <hr class="border-300 my-3" />
            ...
            <div class="dropdown-menu dropdown-menu-right py-0" aria-labelledby="navbarDropdownUser">
              <div class="bg-white rounded-soft py-2">
                <a class="dropdown-item font-weight-bold text-warning" href="javascript:;">
                  <span class="fas fa-crown mr-1"></span><span>{{ Auth::user()->fname }} {{ Auth::user()->lname }}</span>
                </a>
