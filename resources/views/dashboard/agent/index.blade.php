@section('page_title', 'BuyPowerNow - Agent Dashboard')
...
<div class="card-deck">
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
        ...
        <div class="card-body position-relative">
            <h6>Earnings</h6>
            <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif text-warning" data-countupp='{"count":58386,"format":"alphanumeric"}'>NGN 0.00
            </div><a class="font-weight-semi-bold fs--1 text-nowrap" href="/dashboard/earnings">see all earnings<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
        </div>
    </div>
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
        ...
        <div class="card-body position-relative">
            <h6>Transactions</h6>
            <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif text-info" data-countupp='{"count":23434,"format":"alphanumeric"}'>NGN 0.00</div>
            <a class="font-weight-semi-bold fs--1 text-nowrap" href="/dashboard/transaction-history">all transactions
    ...
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
        ...
        <div class="card-body position-relative">
            <h6>Wallet</h6>
            <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif" data-countup='{"count":43594,"format":"comma","prefix":"NGN"}'>NGN 0.00</div>
            <a class="font-weight-semi-bold fs--1 text-nowrap" href="/dashboard/deposit">deposit cash
                <span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span>
            </a>
        </div>
    </div>
