@section('page_title', 'BuyPowerNow - Register Authentication')
                                ...
                                <div class="p-4 p-md-5 flex-grow-1">
                                    ...
                                    <form method="post" action="/register">
                                        ...
                                        <div class="row">
                                            <div class="col-6 ">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('fname') is-invalid @enderror" value="{{ old('fname') }}" required type="text" name="fname" id="card-name" placeholder="" />
                                                    @error('fname')
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('lname') is-invalid @enderror" name="lname" value="{{ old('lname') }}" required type="text" id="card-name" placeholder="" />
                                                    @error('lname')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong style="color: red">{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required class="form-control @error('userid') is-invalid @enderror" name="userid">
